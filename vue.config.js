...
module.exports = {
    ...
    pages: {
        index: {
            ...
            includeCss: ['./lib/idm.base.css'],
        },
    },
    chainWebpack(config) {
        config.externals(externals)
        config.plugin('define').tap(args => {
            args[0]['process.env.CodeVar'] = JSON.stringify(
                'CodeVar_' + getGUID() + '_' + new Date().getTime()
            )
            return args
        })
    ...
    configureWebpack: {
        ...
        output: {
            ...
            jsonpFunction: JSON.stringify(
                'webpackJsonp_' + getGUID() + '_' + new Date().getTime()
            ),
        },
        resolve: {
